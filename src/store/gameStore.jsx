...
export const { changeTurn, changeRow, changeDropped, setTimer, resetTimer, ChoosingTheWinner, givingPoints, emptyBoard,fillWinArray, resetscore,changeRound } = gameStore.actions
